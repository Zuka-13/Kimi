        ...
        <div className="flex items-center justify-center w-full lg:p-12">
            <div className="flex items-center xl:p-10">
                <form className="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl" onSubmit={handleSubmit}>
                    ...
                    <label htmlFor="first_name" className="mb-2 text-sm text-center text-grey-900">First Name*</label>
                    <input
                        id="first_name"
                        type="text"
                    ...
                    <label htmlFor="last_name" className="mb-2 text-sm text-center text-grey-900">Last Name*</label>
                    <input 
                        id="last_name"
                        type="text"
