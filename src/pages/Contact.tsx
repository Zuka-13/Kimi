...
const Contact: FunctionComponent = () => {
  return (
    ...
    <div className="w-full relative bg-darkslategray-200 flex flex-col items-start justify-start pt-0 px-0 pb-[50.3px] box-border gap-[124px] mix-blend-normal leading-[normal] tracking-[normal] mq450:gap-[31px] mq750:gap-[62px]">
      {/* Calling the header module */}
      <HeaderDesktop />
      <main className="w-[1401.4px] flex flex-row items-start justify-start pt-[60px] px-[73px] box-border max-w-full lg:pl-9 lg:pr-9 lg:box-border">
