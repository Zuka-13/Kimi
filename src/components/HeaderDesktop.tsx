...
const HeaderDesktop: FunctionComponent = () => {
  ...
  return (
    <header className="self-stretch bg-kimi-yellow box-border flex flex-row items-start justify-start pt-[31px] px-5 pb-[18px] gap-[57px] mix-blend-normal max-w-full z-[1] border-b-[1px] border-solid border-silver-300 mq800:gap-[28px]">
      <img
      ...
      <div className="flex-1 flex flex-col items-start justify-start pt-[18px] px-0 pb-0 box-border max-w-full">
        <nav className="m-0 self-stretch flex flex-row items-end justify-start gap-[31px] text-center text-xl text-black font-poppins mq800:gap-[15px]">
